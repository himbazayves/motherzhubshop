...
$SelSql = "SELECT * FROM `messages` WHERE messages_id = $messages_id";
...
<body>
						...
						<div class=" col-sm-12 col-lg-">
							...
							<div class="panel">
								<div class="panel-heading">
                                    <h3 class="panel-title">Single message</h3>
    ...
    <tr>
        <td></td>
        <td>
            <a href='admin_message.php' class='btn btn-primary'>Back to message list</a>
        </td>
    </tr>
									</table>
								</div>
