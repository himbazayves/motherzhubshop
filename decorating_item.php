					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								<h3>At the Love of Ballons   </h3>
								
								<div class="faded">
									<p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
									<ul class="ftco-social text-center">
		                <li class="ftco-animate"><a  href="product.php?sub=cereals" class="btn btn-warning text-dark" href="#">See more</a></li>
						...
						<div class="staff">
							...
							<div class="text pt-3 text-center">
								...
								<div class="faded">
									<p>I am an ambitious workaholic, but apart from that, pretty simple person.</p>
									<ul class="ftco-social text-center">
									<li class="ftco-animate"><a class="btn btn-warning text-dark" href="#">Get in Touch</a></li>
		              </ul>
	              </div>
							</div>
						</div>
